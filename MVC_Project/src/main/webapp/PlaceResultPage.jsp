...
<table class="table" >
	...
	<tr>
		<td rowspan="3" align="center"><a href="detail.four?no=${Dto_SearchPlace.no }"><img width="200" src="${Dto_SearchPlace.filePath }"/></a></td>	
		<th width="100">공간유형</th>		
		<td width="180">${Dto_SearchPlace.category }</td>
		<th width="100">이름</th>
		<td width="180"><a href="detail.four?no=${Dto_SearchPlace.no }">${Dto_SearchPlace.title }</a></td>	
	</tr>
	...
	<tr>
		<td colspan="4" align="center">
			...
			<c:forEach items="${pageList }" var="page">
				<a href="SearchPlaceCommand.four?page=${page }&location=${param.location}&categorySpace=${param.categorySpace}&date=${param.date}" class="a">${page }</a>
			</c:forEach>
		</td>
			</tr>
