...
<div class=mainBox>
	<div class="contentBox">
		<div class="textLeft">
			<div class="title" style="font-weight:700;">결제완료 : ${DTO.title}</div>
			<div class="titleBottom"></div>
			<div class="share"><img class="sharePhoto" src="${DTO.filePath }"/></div>
			<div class="shareIntroduce" style="font-weight:700;">추가 정보</div>
			<div class="underline"></div>
			<table>
				<tr>
					<td class="td_title">수용 인원 : </td>
					<td class="td_content">1명 ~ ${DTO.capacity}명</td>
...
<div class=mainBox>
	<div class="map">
		<div class="textLeft">
			<div style="margin-left:20px; margin-top:20px; font-size:25px; font-weight:700;">${DTO.title}<div class="underline" style="margin-top:10px;"></div></div>
			<div style="margin-left:20px; margin-bottom:20px; font-size:17px; "> - ${DTO.address1}${DTO.address2}</div>
		</div>
		...
		// 주소로 좌표를 검색합니다
		geocoder.addressSearch('${DTO.address1}', function(result, status) {
...
<div class=mainBox>
	<div class="contentBox">
		<div class="textLeft">
			<div class="shareIntroduce" style="font-weight:700;">예약자 정보</div>
			<div class="underline"></div>
			<table>
				<tr>
					<td class="td_title">예약자명 </td>
		...
		<div class="textLeft">
			...
			<table>
				<tr>
					...
					<td class="td_content">${DTO.checkInDate} ${DTO.startTime}:00 ~ ${DTO.endTime}:00</td>
